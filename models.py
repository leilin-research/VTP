...
class Encoder(nn.Module):
    ...
    def __init__(
        self, embedding_dim= 16, h_dim=32 , mlp_dim=64, num_layers=1,
        dropout=0.0
    ):
...
class PoolHiddenNet(nn.Module):
    ...
    def __init__(
        ...
        self.mlp_dim = 1024
        self.h_dim = h_dim  #48
        self.bottleneck_dim = bottleneck_dim #48
    ...
    def repeat(self, tensor, num_reps):
        ...
        1 2 3
        4 5 6
        after   repeat 5 times shape:[1,10,3]
        1 2 3
        4 5 6
        1 2 3
        4 5 6
    ...
    def forward(self, h_states, seq_start_end, end_pos):
        ...
        for _, (start, end) in enumerate(seq_start_end):
            ...
            num_ped = end - start  # some num like 7
            curr_hidden = h_states.view(-1, self.h_dim)[start:end]   #curr_hidden shape : [some_num like 7, 48]
            curr_end_pos = end_pos[start:end]  

            # Repeat -> H1, H2, H1, H2
            curr_hidden_1 = curr_hidden.repeat(num_ped, 1)  # torch repeat funciton [som)num **2 = 49, 48]
            
            # Repeat position -> P1, P2, P1, P2
            curr_end_pos_1 = curr_end_pos.repeat(num_ped, 1)  #[49,2]
            
            # Repeat position -> P1, P1, P2, P2
            curr_end_pos_2 = self.repeat(curr_end_pos, num_ped)  #[49,2]


            curr_rel_pos = curr_end_pos_1 - curr_end_pos_2  #[49,2]
            curr_rel_embedding = self.spatial_embedding(curr_rel_pos) #[49,64]
            mlp_h_input = torch.cat([curr_rel_embedding, curr_hidden_1], dim=1)  #[49,112]
            curr_pool_h = self.mlp_pre_pool(mlp_h_input)  #[49,48]
            curr_pool_h = curr_pool_h.view(num_ped, num_ped, -1).max(1)[0]  #[7, 48]
...
class TrajectoryDiscriminator(nn.Module):
    ...
    def forward(self, traj, traj_rel, seq_start_end=None):
        ...
        """
        # traj shape: [20, num, 2]
        final_h = self.encoder(traj_rel)  #[1, num, 48]
